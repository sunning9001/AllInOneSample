...
public final class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.grpc.hello.Helloworld.HelloRequest,
      com.example.grpc.hello.Helloworld.HelloReply> METHOD_HELLO =
      io.grpc.MethodDescriptor.<com.example.grpc.hello.Helloworld.HelloRequest, com.example.grpc.hello.Helloworld.HelloReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "grpc.hello.HelloService", "Hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.hello.Helloworld.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.grpc.hello.Helloworld.HelloReply.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.example.grpc.hello.Helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.hello.Helloworld.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.hello.Helloworld.HelloRequest,
                com.example.grpc.hello.Helloworld.HelloReply>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.hello.Helloworld.HelloReply hello(com.example.grpc.hello.Helloworld.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.hello.Helloworld.HelloReply> hello(
        com.example.grpc.hello.Helloworld.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.example.grpc.hello.Helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.hello.Helloworld.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static final class HelloServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.hello.Helloworld.getDescriptor();
    }
  }

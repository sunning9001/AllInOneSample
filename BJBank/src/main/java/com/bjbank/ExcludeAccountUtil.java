 ...
 *
 */
public class ExcludeAccountUtil {

	public static Map<String, ExcludeAccount> map =new HashMap<String, ExcludeAccount>();
	
	public static void addAccountMatch(ExcludeAccount am) {
		if(am!=null) {

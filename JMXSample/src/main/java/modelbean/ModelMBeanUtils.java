...
public class ModelMBeanUtils {
	...
	private static ModelMBeanInfo createModelMBeanInfo() {
		...
		//////////////////////////////////////////////////////////////////
		// 构造 getName操作描述符信息
		Descriptor getStateDesc = new DescriptorSupport(new String[] { "name=getName", "descriptorType=operation",
				"class=com.test.jmx.modelBean.Hello", "role=operation" });
		...
		// 构造 setName操作描述符信息
		Descriptor setStateDesc = new DescriptorSupport(new String[] { "name=setName", "descriptorType=operation",
				"class=com.test.jmx.modelBean.Hello", "role=operation" });
		...
		ModelMBeanInfo mbeanInfo = new ModelMBeanInfoSupport(//
				...
				new ModelMBeanOperationInfo[] { // 所有的操作信息（数组）
						getName, setName, print1Info, print2Info }, //
				null, // 所有的通知信息(本例无)
				null// MBean描述
		);
		return mbeanInfo;
